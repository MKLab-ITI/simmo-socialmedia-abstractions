...
public class FacebookPost extends gr.iti.mklab.simmo.documents.Post {
    ...
    public FacebookPost(Post post) {
        ...
        if (place != null) {
            ...
            if (loc != null) {
                ...
                location = new gr.iti.mklab.simmo.util.Location(latitude, longitude);
        ...
        if (type.equals("photo")) {
            ...
            if (picture != null) {
                ...
                try {
                    ...
                    String mediaId = Sources.FACEBOOK + "#" + post.getId();
                    //url
                    gr.iti.mklab.simmo.items.Video v = new gr.iti.mklab.simmo.items.Video();
    ...
    public FacebookPost(Comment comment, Post post, User user) {
        ...
        gr.iti.mklab.simmo.documents.Post originalPost = new gr.iti.mklab.simmo.documents.Post();
